    ...
    {#if copyable && value !== undefined && value !== null}
      ...
      >
        ...
        {:else}
          <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path
              d="M3.5 2A1.5 1.5 0 002 3.5v8A1.5 1.5 0 003.5 13h.55a.5.5 0 000-1H3.5a.5.5 0 01-.5-.5v-8a.5.5 0 01.5-.5h5a.5.5 0 01.5.5V4h2.5a.5.5 0 01.5.5v.55a.5.5 0 001 0V4.5A1.5 1.5 0 0011.5 3H9v-.5A1.5 1.5 0 007.5 1h-4z"
            />
            <path
              d="M6.5 5A1.5 1.5 0 005 6.5v8A1.5 1.5 0 006.5 16h6a1.5 1.5 0 001.5-1.5v-8A1.5 1.5 0 0012.5 5h-6zm0 1h6a.5.5 0 01.5.5v8a.5.5 0 01-.5.5h-6a.5.5 0 01-.5-.5v-8a.5.5 0 01.5-.5z"
            />
          </svg>
        {/if}
      </button>
